...
const Modal: React.FC = () => {
  return (
    <ImageBackground source={require('@assets/4.gif')} style={styles.background}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.teamContainer}>
            <View style={styles.member}>
              <Image source={require('@assets/1.jpg')} style={styles.memberImage} />
            ...
            <View style={styles.member}>
              <Image source={require('@assets/2.jpg')} style={styles.memberImage} />
